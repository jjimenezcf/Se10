...
namespace MVCSistemaDeElementos.Descriptores
{
    ...
    public class FiltroConNumero<TElemento> : ControlFiltroHtml where TElemento : ElementoDto
    {
        ...
        public FiltroConNumero(IControlHtml padre, string etiqueta, string propiedad, string ayuda, Posicion posicion = null,
        ...
        public override string RenderControl()
        {
            ...
            var ConEditor = RenderFiltroConNumero(a); // EditorDeTexto.RenderEditorDeTextoParaFiltrar(a);
        ...
        private string RenderFiltroConNumero(AtributosHtml atributos)
        {
            ...
            valores["Css"] = Css.Render(enumCssFiltro.Numero);
