namespace Crud {
    ...
    export class CrudMnt extends GridDeDatos {
        ...
        protected Expansor_InyectarAccesoIA(): void {
            ApiPreguntasIa.InyectarAccesoIA(this);
        }

        public Expansor_ModalPreguntarIA(): void {
            ApiPreguntasIa.AbrirModal(this);
        }

        public LanzarPregunta(texto: string): void {
            ApiPreguntasIa.LanzarPregunta(this, texto);
        }
        ...
        public async MostrarPanelDeTotales(controlador: string) {
            ...
            if (panelEstabaEnGraficos) {
                const contenedorControles = this.PanelDeTotales;
                if (Definido(contenedorControles))
                    ApiDeGraficos.InsertarGraficaDeTotales(contenedorControles, null);
            }
            ApiPanel.AbrirModal(modal);
        }
