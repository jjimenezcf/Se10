...
BEGIN
    ...
    BEGIN
       delete NEGOCIO.PARAMETRO WHERE NOMBRE LIKE ''CAD_IdsDeTiposDeLotesContables''
       delete NEGOCIO.PARAMETRO WHERE NOMBRE LIKE ''CAD_IdDeTipoDeEstimacionDirecta''
       PRINT ''Eliminado en ' + @DatabaseName + '''
    END
    ELSE
    BEGIN
