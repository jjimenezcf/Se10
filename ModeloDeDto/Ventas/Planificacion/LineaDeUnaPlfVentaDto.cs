...
namespace ModeloDeDto.Ventas
{
    ...
    public class LineaDeUnaPlfVentaDto : EsUnDetalleDto
    {
        ...
        [IUPropiedad(
            ...
            trasBlanquear = "javascript:" + nameof(enumNameSpaceTs.Venta) + "." + nameof(enumFunctionTs.Plv_Tras_Blanquear_Unitario) + "()",
            AutoSpan = true
            )
        ]
