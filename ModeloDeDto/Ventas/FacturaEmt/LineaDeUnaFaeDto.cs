...
namespace ModeloDeDto.Ventas
{
    ...
    public class LineaDeUnaFaeDto : EsUnDetalleDto
    {
        ...
        [IUPropiedad(
            ...
            OnChange = "javascript:" + nameof(enumNameSpaceTs.Venta) + "." + nameof(enumFunctionTs.Fae_Tras_Cambiar_TipoDeLinea) + "()",
            Fila = 1,
            Columna = 1,
        ...
        [IUPropiedad(
            ...
            Obligatorio = false,
            EditableAlEditar = false,
            trasSeleccionar = "javascript:" + nameof(enumNameSpaceTs.Venta) + "." + nameof(enumFunctionTs.Fae_Tras_Seleccionar_Unitario) + "(["+nameof(enumParamTs.idLista)+"])",
            trasBlanquear = "javascript:" + nameof(enumNameSpaceTs.Venta) + "." + nameof(enumFunctionTs.Fae_Tras_Blanquear_Unitario) + "()",
            AutoSpan = true
            )
        ]
        ...
        [IUPropiedad(
            ...
            OnChange = "javascript:" + nameof(enumNameSpaceTs.Venta) + "." + nameof(enumFunctionTs.Fae_IvaRepercutidoCambiado) + "()",
            OnBlur = "javascript:" + nameof(enumNameSpaceTs.Venta) + "." + nameof(enumFunctionTs.Fae_CalcularImportesDeLinea) + "()",
            Obligatorio = false,
            ColSpan = 2,
            VisibleEnGrid = false,
