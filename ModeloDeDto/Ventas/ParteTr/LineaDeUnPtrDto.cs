...
namespace ModeloDeDto.Ventas
{
    ...
    public class LineaDeUnPtrDto : EsUnDetalleDto
    {
        ...
        [IUPropiedad(
            ...
            OnChange = "javascript:" + nameof(enumNameSpaceTs.Venta) + "." + nameof(enumFunctionTs.Ptr_Tras_Cambiar_TipoDeLinea) + "()",
            Fila = 1,
            Columna = 1,
        ...
        [IUPropiedad(
            ...
            Obligatorio = false,
            EditableAlEditar = false,
            trasSeleccionar = "javascript:" + nameof(enumNameSpaceTs.Venta) + "." + nameof(enumFunctionTs.Ptr_Tras_Seleccionar_Unitario) + "(["+nameof(enumParamTs.idLista)+"])",
            trasBlanquear = "javascript:" + nameof(enumNameSpaceTs.Venta) + "." + nameof(enumFunctionTs.Ptr_Tras_Blanquear_Unitario) + "()",
            AutoSpan = true
            )
        ]
        ...
        [IUPropiedad(
          Etiqueta = "Concepto",
          Ayuda = "Concepto del parte de trabajo",
          Tipo = typeof(string),
        ...
        [IUPropiedad(
           Etiqueta = "Cantidad",
           Tipo = typeof(decimal),
           Ayuda = "cantidad realizada",
           TipoDeControl = enumTipoControl.Editor,
           Alineada = enumAliniacion.derecha,
           OnBlur = "javascript:" + nameof(enumNameSpaceTs.Venta) + "." + nameof(enumFunctionTs.Ptr_CalcularImportesDeLinea) + "()",
           Obligatorio = false,
        ...
        [IUPropiedad(
            ...
            OnChange = "javascript:" + nameof(enumNameSpaceTs.Venta) + "." + nameof(enumFunctionTs.Ptr_IvaRepercutidoCambiado) + "()",
            OnBlur = "javascript:" + nameof(enumNameSpaceTs.Venta) + "." + nameof(enumFunctionTs.Ptr_CalcularImportesDeLinea) + "()",
            Obligatorio = false,
            ColSpan = 2,
            VisibleEnGrid = false,
