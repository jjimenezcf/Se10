...
namespace ModeloDeDto.Juridico
{
    ...
    public class LineaDeUnPlfVentaDto : EsUnDetalleDto
    {
        ...
        [IUPropiedad(
            ...
            OnChange = "javascript:" + nameof(enumNameSpaceTs.Juridico) + "." + nameof(enumFunctionTs.Plv_Tras_Cambiar_TipoDeLinea) + "()",
            Fila = 1,
            Columna = 0,
            Posicion = 1,
        ...
        //----------------------------------------------
        [IUPropiedad(
            Etiqueta = nameof(Lote),
            Ayuda = "Lote del planificador",
            TipoDeControl = enumTipoControl.RestrictorDeEdicion,
            Obligatorio = false,
            MostrarExpresion = nameof(Lote),
            Negocio = enumNegocio.LoteDeUnContrato,
            Controlador = nameof(enumControladoresJuridicos.LotesDeUnContrato),
            VistaDondeNavegar = enumVistasJuridicos.CrudLotes,
            Fila = 1,
            Columna = 1,
            Posicion = 0,
            VisibleEnGrid = false
        ...
        [IUPropiedad(Etiqueta = "Lote", Visible = false)]
        ...
        [IUPropiedad(
            ...
            Ordenar = true,
            EditableAlEditar = false,
            trasSeleccionar = "javascript:" + nameof(enumNameSpaceTs.Juridico) + "." + nameof(enumFunctionTs.Plv_Tras_Seleccionar_Unitario) + "([" + nameof(enumParamTs.idLista) + "])",
            trasBlanquear = "javascript:" + nameof(enumNameSpaceTs.Juridico) + "." + nameof(enumFunctionTs.Plv_Tras_Blanquear_Unitario) + "()",
            antesDeBuscar = "javascript:" + nameof(enumNameSpaceTs.Juridico) + "." + nameof(enumFunctionTs.Plv_Antes_De_Buscar_Unitarios),
            AutoSpan = true
            )
        ]
        ...
        [IUPropiedad(
           Etiqueta = "Cantidad",
           Tipo = typeof(decimal),
           Ayuda = "cantidad planificada",
           TipoDeControl = enumTipoControl.Editor,
           Alineada = enumAliniacion.derecha,
           OnBlur = "javascript:" + nameof(enumNameSpaceTs.Juridico) + "." + nameof(enumFunctionTs.Plv_CalcularImportesDeLinea) + "()",
        ...
        public decimal? BaseImponible => ImporteDeDto.HasValue && ImporteSinDto.HasValue ? ImporteSinDto.Decimal() - ImporteDeDto.Decimal(): null;
        ...
        [IUPropiedad(
            ...
            OnChange = "javascript:" + nameof(enumNameSpaceTs.Juridico) + "." + nameof(enumFunctionTs.Plv_IvaRepercutidoCambiado) + "()",
            OnBlur = "javascript:" + nameof(enumNameSpaceTs.Juridico) + "." + nameof(enumFunctionTs.Plv_CalcularImportesDeLinea) + "()",
            Obligatorio = false,
            ColSpan = 2,
            VisibleEnGrid = false,
