...
namespace ModeloDeDto.Gastos
{
    ...
    public class FacturaRecDto : ElementoDeUnProcesoDto, IPrioridadDto
    {
        ...
        [IUPropiedad(
            ...
            RestrictorFijo = ltrDeUnExpediente.SelectorParaUnaFacturaRec + Simbolos.PuntoComa + nameof(enumEtapasDeExpedientes.EXP_Etapa_Ejecucion) + Simbolos.separadorDeEtapas + nameof(enumEtapasDeExpedientes.EXP_Etapa_Terminada),
            Fila = 4,
            Columna = 2,
            Posicion = 0,
            EditableAlCrear = true,
