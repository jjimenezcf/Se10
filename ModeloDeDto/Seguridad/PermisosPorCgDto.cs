...
namespace ModeloDeDto.Seguridad
{
    ...
    public class PermisosPorTransicionDto : ElementoDto
    {
        //--------------------------------------------
        [IUPropiedad(
            Etiqueta = "Negocio",
        ...
        [IUPropiedad(
            Etiqueta = "Transicion",
            Ayuda = "Transicion del negocio tratado",
            TipoDeControl = enumTipoControl.RestrictorDeEdicion,
        ...
        [IUPropiedad(
            Etiqueta = "Permiso del transicion",
            ...
            BuscarPor = nameof(ltrDeUnPermisoDtm.PermisosDeTransicion),
            Fila = 1,
            Columna = 0
            )
        ]
