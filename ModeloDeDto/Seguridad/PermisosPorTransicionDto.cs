...
namespace ModeloDeDto.Seguridad
{
    ...
    public class PermisosPorCgDto : ElementoDto
    {
        //--------------------------------------------
        [IUPropiedad(
            Etiqueta = "Negocio",
            Ayuda = "Negocio del permiso",
        ...
        [IUPropiedad(
            ...
            Ayuda = "centro gestor del negocio tratado",
            TipoDeControl = enumTipoControl.RestrictorDeEdicion,
            MostrarExpresion = nameof(Cg),
            Fila = 0,
            Columna = 1,
            VisibleAlCrear = false,
            EditableAlEditar = false,
        ...
        [IUPropiedad(
            ...
            BuscarPor = nameof(ltrDeUnPermisoDtm.PermisosDeCg),
            Fila = 1,
            Columna = 0
            )
        ]
