...
namespace ModeloDeDto.Seguridad
{
    ...
    public class PermisosPorElementoDto : ElementoDto
    {
        //--------------------------------------------
        [IUPropiedad(
            Etiqueta = "Negocio",
        ...
        [IUPropiedad(
            Etiqueta = "Elemento",
            Ayuda = "Elemento al que aplica el permisos",
            TipoDeControl = enumTipoControl.RestrictorDeEdicion,
        ...
        [IUPropiedad(
            ...
            BuscarPor = nameof(ltrDeUnPermisoDtm.PermisosDeElemento),
            Fila = 1,
            Columna = 0
            )
        ]
