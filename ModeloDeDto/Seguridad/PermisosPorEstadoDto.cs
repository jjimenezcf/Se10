...
namespace ModeloDeDto.Seguridad
{
    ...
    public class PermisosPorEstadoDto : ElementoDto
    {
        //--------------------------------------------
        [IUPropiedad(
            Etiqueta = "Negocio",
        ...
        [IUPropiedad(
            Etiqueta = "Estado",
            Ayuda = "Estado del negocio tratado",
            TipoDeControl = enumTipoControl.RestrictorDeEdicion,
        ...
        [IUPropiedad(
            ...
            BuscarPor = nameof(ltrDeUnPermisoDtm.PermisosDeEstado),
            Fila = 1,
            Columna = 0
            )
        ]
