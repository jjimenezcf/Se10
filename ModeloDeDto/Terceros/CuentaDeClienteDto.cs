...
namespace ModeloDeDto.Terceros
{
    ...
    public class CuentaDeClienteDto : EsUnDetalleDto, IAuditadoDto
    {
        ...
        [IUPropiedad(Etiqueta = "", Ayuda = "Iban (País-DC) o Pegue el nº de cuenta", 
            ...
            LongitudMaxima = 4, 
            EditableAlEditar = false,
            OnPaste = "javascript:" + nameof(enumNameSpaceTs.Terceros) + "." + nameof(enumFunctionTs.Cli_AlPegar_Iban) + "(event)")
        ]
        ...
        [IUPropiedad(
           Etiqueta = "Activa",
           Ayuda = "indica si la cuenta del cliente está activa",
           VisibleEnGrid = false,
           Obligatorio = false,
           Fila = 5,
           Columna = 0,
           ...
           OnChange = "javascript:" + nameof(enumNameSpaceTs.Terceros) + "." + nameof(enumFunctionTs.Cli_AlCambiar_CuentaActiva) + "(this)"
           )]
