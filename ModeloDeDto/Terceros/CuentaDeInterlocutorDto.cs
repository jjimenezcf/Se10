...
namespace ModeloDeDto.Terceros
{
    ...
    public class CuentaDeInterlocutorDto : EsUnDetalleDto, IAuditadoDto
    {
        ...
        [IUPropiedad(Etiqueta = "", Ayuda = "Iban (País-DC) o Pegue el nº de cuenta", 
            ...
            LongitudMaxima = 4, 
            EditableAlEditar = false,
            OnPaste = "javascript:" + nameof(enumNameSpaceTs.Terceros) + "." + nameof(enumFunctionTs.Int_AlPegar_Iban) + "(event)")
        ]
        ...
        [IUPropiedad(Etiqueta = "", Ayuda = "DC", Fila = 1, Columna = 3, Posicion = 0, LongitudMaxima = 2, EditableAlEditar = false, AnchoMaximo = "3em")]
        public string DcCcc { get; set; }
        [IUPropiedad(Etiqueta = "", Ayuda = "Número", Fila = 1, Columna = 3, Posicion =1, LongitudMaxima =10, EditableAlEditar = false, AutoSpan = true)]
        ...
        [IUPropiedad(
           Etiqueta = "Activa",
           Ayuda = "indica si la cuenta del interlocutor está activa",
           VisibleEnGrid = false,
           Obligatorio = false,
           Fila = 5,
           Columna = 0,
           ...
           OnChange = "javascript:" + nameof(enumNameSpaceTs.Terceros) + "." + nameof(enumFunctionTs.Int_AlCambiar_CuentaActiva) + "(this)"
           )]
