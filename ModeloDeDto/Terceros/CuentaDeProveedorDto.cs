...
namespace ModeloDeDto.Terceros
{
    ...
    public class CuentaDeProveedorDto : EsUnDetalleDto, IAuditadoDto
    {
        ...
        [IUPropiedad(Etiqueta = "", Ayuda = "Iban (País-DC) o Pegue el nº de cuenta", 
            ...
            LongitudMaxima = 4, 
            EditableAlEditar = false,
            OnPaste = "javascript:" + nameof(enumNameSpaceTs.Terceros) + "." + nameof(enumFunctionTs.Prv_AlPegar_Iban) + "(event)")
        ]
        ...
        [IUPropiedad(
           Etiqueta = "Activa",
           Ayuda = "indica si la cuenta del proveedor está activa",
           VisibleEnGrid = false,
           Obligatorio = false,
           Fila = 5,
           Columna = 0,
           ...
           OnChange = "javascript:" + nameof(enumNameSpaceTs.Terceros) + "." + nameof(enumFunctionTs.Prv_AlCambiar_CuentaActiva) + "(this)"
           )]
