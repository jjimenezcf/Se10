...
namespace ModeloDeDto.Terceros
{
    ...
    public class CuentaDeMiSociedadDto : EsUnDetalleDto, IAuditadoDto
    {
        ...
        [IUPropiedad(Etiqueta = "", Ayuda = "Iban (País-DC) o Pegue el nº de cuenta", 
            ...
            LongitudMaxima = 4, 
            EditableAlEditar = false,
            OnPaste = "javascript:" + nameof(enumNameSpaceTs.Terceros) + "." + nameof(enumFunctionTs.Sociedad_AlPegar_Iban) + "(event)")
        ]
        ...
        [IUPropiedad(
           Etiqueta = "Activa",
           Ayuda = "indica si la cuenta de la sociedad está de activa",
           VisibleEnGrid = false,
           Obligatorio = false,
           Fila = 5,
           Columna = 0,
           ...
           VisibleAlCrear = false,
           EditableAlEditar = true,
           OnChange = "javascript:" + nameof(enumNameSpaceTs.Terceros) + "." + nameof(enumFunctionTs.Sociedad_AlCambiar_CuentaActiva) + "(this)"
           )]
